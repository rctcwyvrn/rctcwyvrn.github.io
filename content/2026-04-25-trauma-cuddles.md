...
An immense pain that we just _wish_ so badly that we could be free from.
...
### _We need the space to just figure out how to Be..._
...
But some still are deep, and point towards the kind of escape and yearning that some of us traumatized trans women so so _so_ desire.
...
_The kind of healing that I desperately need_
